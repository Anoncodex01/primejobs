...
import {
  ...
  CloudCheck as CloudCheckIcon2,
  CloudX as CloudXIcon2,
  CloudPlus as CloudPlusIcon2,
  CloudMinus as CloudMinusIcon2,
  CloudEdit as CloudEditIcon2,
  CloudSearch as CloudSearchIcon2
} from 'lucide-react';
